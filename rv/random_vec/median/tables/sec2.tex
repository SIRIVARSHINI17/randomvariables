...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-10\\-1.5}$}}
	&\multicolumn{3}{c|}%
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-1.5\\10}$}}
	&
	&
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{32.5}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-3\\3.5}$}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{6.5\\4.5}$}}
	&\multicolumn{3}{c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColF}%
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{4.5\\-6.5}$}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-1.67\\3}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
